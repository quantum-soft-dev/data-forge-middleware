...
**Blocked until**: product sign-off of plan.md (incl. OQ-1…OQ-4) **and** 022/023 merged to develop.
...
- [ ] **T001** [A1] Promote tokens to shared module
...
- [ ] **T002** [A2] Remap shadcn CSS variables to monitoring palette
...
- [ ] **T003** [A3] Extend Tailwind theme with semantic monitoring utilities
...
- [ ] **T004** [A4] Restyle Badge primitive → alpha pills + dot
...
- [ ] **T005** [A5] Restyle Button primitive
...
- [ ] **T006** [A6] Restyle Card primitive
...
- [ ] **T007** [A7] Restyle Table primitive (keep `<table>` semantics — research D4)
...
- [ ] **T008** [A8] Tabs primitive: site-detail treatment as default
...
- [ ] **T009** [A9] Restyle form primitives: Input, Select, Checkbox, Label
...
- [ ] **T010** [A10] Dialog & AlertDialog pass
...
- [ ] **T011** [A11] Skeleton, Alert, Separator
...
- [ ] **T012** [A12] New shared PageHeader component
...
- [ ] **T013** [B1] Migrate global Header/navigation
...
- [ ] **T014** [C1a] Dashboard page scaffold
...
- [ ] **T015** [C1b] Dashboard chart widgets
...
- [ ] **T016** [C1c] Global errors widget + list
...
- [ ] **T017** [C2a] Site Management page scaffold
...
- [ ] **T018** [C2b] CreateSiteForm polish on new primitives
...
- [ ] **T020** [C2d] SiteListItem — finish the partial migration
...
- [ ] **T021** [C3a] Upload History page scaffold
...
- [ ] **T022** [C3b] BatchListView (largest single-file migration)
...
- [ ] **T024** [C3d] BatchDetailView (v1) + ErrorListView
...
- [ ] **T025** [C4a] Comparisons list page + widget chrome
...
- [ ] **T026** [C4b] Comparison list rows/cards
...
- [ ] **T027** [C4c] Comparison detail + diff viewer chrome
...
- [ ] **T028** [C5a] My Plugins page + widget tabs/filters
...
- [ ] **T030** [C5c] My Plugins logs & SQL tables
...
- [ ] **T031** [C6] Admin plugins area (page+tabs, list view, audit/SQL tables, status badge)
...
- [ ] **T033** [C8] Device-verify, login/fallback, admin sites & settings
...
- [ ] **T034** [D1] Delta Sync surfaces re-point to shared tokens (zero pixel drift)
...
- [ ] **T036** [D3] Mechanical audit + feature documentation
