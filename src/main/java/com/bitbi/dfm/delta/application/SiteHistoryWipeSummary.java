 ...
 * @param s3DeleteErrors        objects the bucket refused to delete, or — when the delete phase
 *                              failed outright — every object it was handed, the honest upper bound.
 *                              Orphans, not data loss: the rows naming them are already gone, and
 *                              re-running the wipe is safe and is what sweeps them
