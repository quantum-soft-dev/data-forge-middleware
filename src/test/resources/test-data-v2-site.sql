...
VALUES ('0199bab0-4444-4444-4444-444444444444', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'store-v2.example.com', '$2a$10$w4ybRJqsZPH4IWHXHaN1rukDAfZc6Ri4P45Hpk3mlfbZpHIHYYyBm', 'Store V2 (Delta gRPC)', true, '2026-07-05 00:00:00', CURRENT_TIMESTAMP, 'store-v2.example.com', 'V2');
...
VALUES ('b1c2d3e4-f5a6-7890-bcde-f12345678907', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '0199bab0-4444-4444-4444-444444444444', 'IN_PROGRESS', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890/store-v2.example.com/2026-07-05/10-00/', 1, 1024, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
