...
| Browser shows **Code Expired** | The submitted `userCode` was valid but its authorization window elapsed | Start a new authorization request on the device; the verification page distinguishes this from an unknown code |
