...
| [delta-client-v2-guide.md](./delta-client-v2-guide.md) | Delta v2 protocol, segment egress, unified batch/table Parquet and queue operations, Sync UI (022/023/025/036/038/039/040) | Backend, Client integrators |
| [cr-unified-batch-parquet.md](./cr-unified-batch-parquet.md) | Unified completed-batch Parquet contract, fan-out cost model, claim-isolated storage, operations and compatibility boundary (036/038/039/040, issues #93/#97/#98/#100) | Backend, Architects |
