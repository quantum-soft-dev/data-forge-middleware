...
- **Migrations (Flyway)**: forward-only, sequential `V{N}__description.sql`; never edit an applied migration; backward-compatible defaults for new NOT NULL columns. Current at **V44**, next is **V45**.
...
- Migrations current at **V44**; next migration is **V45** (do not reuse numbers)
