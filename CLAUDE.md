...
- **Migrations (Flyway)**: forward-only, sequential `V{N}__description.sql`; never edit an applied migration; backward-compatible defaults for new NOT NULL columns. Current at **V50**, next is **V51**.
...
- Migrations current at **V50**; next migration is **V51** (do not reuse numbers)
